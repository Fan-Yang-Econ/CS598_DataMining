...
def _get_lemma(word: str):
    from NLP_News.SpacyTools import get_or_load_spacy_model
    tokens = get_or_load_spacy_model()(word)
    if len(tokens) == 1:
...
def _integration_test():
    ...
    tokens = get_or_load_spacy_model()(
    ...
    print(list(subject_verb_object_triples(tokens)))
